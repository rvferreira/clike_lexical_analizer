...
public class ParseException extends Exception {
  ...
  private static String initialise(Token currentToken,
    ...
    String retval = "Abestado, encontramos ";
    ...
    if (expectedTokenSequences.length == 1) {
      retval += "Quando na verdade, queriamos ter encontrado:" + eol + "    ";
    } else {
      retval += "Quando na verdade, queriamos ter encontrado um desses:" + eol + "    ";
    }
